                ...
                <div class="row align-items-center justify-content-between">
                    <div class="col-xl-6 col-md-6">
                        <div class="intro-content">
                            <h2>
                                The complete Treemium cryptocurrency Exchange
                                VueJS App
                            </h2>
                            <p>
                                Sign in, Signup, Phone and ID card verification,
                                One time password verify and add bank, debit
                                card settings and profile etc pages included.
                            </p>
                            <router-link
                                to="#"
                                class="btn btn-primary"
                ...
                <div class="row align-items-center">
                    <div class="col-xl-6 col-md-6">
                        <div class="copy_right">
                            Copyright © {{ new Date().getFullYear() }} Quixlab.
                            All Rights Reserved.
                        </div>
                    </div>
                    <div class="col-xl-6 col-md-6 text-lg-right text-center">
                        <div class="social">
                            ...
                            ></router-link>
                            <router-link to="https://twitter.com/quixlab"
